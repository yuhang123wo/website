     ...
     <section>
      <ul class="ulColumn2">
       <li>
        ...
        <input type="text" class="textbox textbox_295" placeholder="角色名..." id="name"/>
       ...
       <li>
        ...
        <textarea  class="textbox_295" placeholder="角色描述..." cols="5" rows="5" id="remark"></textarea>
     <!--    <span class="errorTips"></span> -->
       </li>
       <li>
        <span class="item_name" style="width:120px;">权限选择：</span>
         <label class="single_selection textbox_295"><ul id="tt" class="easyui-tree" url="${pageContext.request.contextPath}/sys/role/allMenu"
